...
get the app created:
    ...
    $ heroku apps:create hipslack
    Creating hipslack... done, stack is cedar
    http://hipslack.herokuapp.com/ | git@heroku.com:hipslack.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://hipslack.herokuapp.com deployed to Heroku

    To git@heroku.com:hipslack.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://hipslack.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@hipslack.herokuapp.com/repl
